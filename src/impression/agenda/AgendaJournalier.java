...
public class AgendaJournalier extends Agenda {
    ...
    int idUser;
    int nbrPageTotal = 365;

    public AgendaJournalier(int idimpression, src.impression.Qualite qualite, src.impression.Format format, int idutilisateur, int nombrepagestotal) {
