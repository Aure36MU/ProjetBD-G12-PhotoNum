...
public class CodeUniversel extends CodePromo {
	...
	public CodeUniversel(int idcodepromo, Date dateacquisition, Date dateutilisation, String code, int taux, int idutilisateur) {
