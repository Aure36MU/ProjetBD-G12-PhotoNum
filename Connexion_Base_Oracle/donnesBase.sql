...
insert into adresse (rue , codePostal, ville , pays, idUser)  values ('1 boulevard des bienheureux' , 97400, 'Saint Denis' , 'La reunion' , (select idUser from utilisateur where mail='tt@mail.fr'));
...
insert into FichierImg (chemin , infoPVue,pixelImg , partager, idUser,dateUtilisation,fileAttModif,fileAttSuppr)  values ('c:/MesDocuments/image/chat.png' , 'chat', 256 ,0 , '24/01/2019',0,0, (select idUser from utilisateur where mail=Smi@mail.us'));
insert into FichierImg (chemin , infoPVue,pixelImg , partager, idUser,dateUtilisation,fileAttModif,fileAttSuppr)  values ('c:/MesDocuments/image/chien.png' , 'chien', 256 ,0 , '24/01/2019',0,0, (select idUser from utilisateur where mail=Smi@mail.us'));
insert into FichierImg (chemin , infoPVue,pixelImg , partager, idUser,dateUtilisation,fileAttModif,fileAttSuppr)  values ('c:/MesDocuments/image/hamster.png' , 'hamster', 256 ,0 , '24/01/2019',0,0, (select idUser from utilisateur where mail=Smi@mail.us'));
