create table Utilisateur (idUser INTEGER PRIMARY KEY NOT NULL,nom Varchar2(100),prenom Varchar2(100),mdp Varchar2(100),email Varchar2(100),active integer check (active in (0,1)), statut Varchar2(20))
create table Adresse (idAdre INTEGER PRIMARY KEY NOT NULL,ville Varchar2(100),codePostal INTEGER,rue Varchar2(100),pays Varchar2(100),idUser INTEGER,CONSTRAINT FK_Adresse FOREIGN KEY (idUser) REFERENCES Utilisateur(idUser))
...
create table Catalogue (type Varchar2(100),format Varchar2(100),modele Varchar2(100),prix INTEGER,qteStock INTEGER,CONSTRAINT primary_tfm PRIMARY KEY (type,format,modele))
...
create table Calendrier (idImp INTEGER PRIMARY KEY NOT NULL,modele Varchar2(20),CONSTRAINT FK_Calendrier FOREIGN KEY (idImp) REFERENCES Impression(idImp))
...
create table Agenda (idImp INTEGER PRIMARY KEY NOT NULL,type Varchar2(20),CONSTRAINT FK_Agenda FOREIGN KEY (idImp) REFERENCES Impression(idImp))
create table Cadre (idImp INTEGER PRIMARY KEY NOT NULL,modele Varchar2(20),CONSTRAINT FK_Cadre FOREIGN KEY (idImp) REFERENCES Impression(idImp))
