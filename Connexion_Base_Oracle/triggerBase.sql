...
Create trigger Adresse_existant_contrainte
After insert or update on Utilisateur
DECLARE
	Nombre int
BEGIN
	Select count(A1.idAdre) into Nombre
From (Select * From Adresse) A1 JOIN (Select * From Adresse) A2 ON (A1.idUser=A2.idUSer)
Where A1.idAdre<>A2.idUser and A1.ville=A2.ville and A1.codePostale=A2.codePostale and A1.rue=A2.rue and A1.pays=A2.pays;
...
L'implémentation des identifiants de chaque table
Create trigger Increment_Utilisateur_contrainte
...
Create trigger Increment_Adresse_contrainte
...
Create trigger Increment_Article_contrainte
...
Create trigger Increment_Impression_contrainte
...
Create trigger Increment_FichierImp_contrainte
Before insert on FichierImp
for each row
BEGIN
...
Create trigger Increment_Photo_contrainte
...
Create trigger Increment_CodePromo_contrainte
